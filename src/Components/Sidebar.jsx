                ...
                <div>
                  ...
                  <ul className={`${isDropdownOpen ? 'block' : 'hidden'} py-2 space-y-2`}>
                    ...
                    <li className="relative group">
                      ...
                      <ul className="absolute left-0 z-10 hidden w-full bg-white dark:bg-gray-800 border dark:border-gray-700 rounded shadow-md group-hover:block">
                        <li>
                          <Link
                            to="/categories/all"
                            className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm text-gray-900 dark:text-white"
                          >
                            All
                          </Link>
                        </li>
